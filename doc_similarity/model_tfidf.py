...
def tfidf_recommendation(news_arr):
  ## max_df -- to ignore words with frequency more than 0.8 
  ## these words can be useless words as these words may appear only once and may not have a significant meaning
